    ...
    <div class="site-header hamburger-menu">
        <nav class="site-nav">
            <ul class="site-nav__list site-nav__list--vertical nav" id="nav2">
                <li class="site-nav__item site-nav__item--vertical"><a href="#poczatek" class="site-nav__link active">początek</a></li>
                <li class="site-nav__item site-nav__item--vertical"><a href="#czym-sie-zajmujemy" class="site-nav__link">czym się zajmujemy</a></li>
                <li class="site-nav__item site-nav__item--vertical"><a href="#oferta" class="site-nav__link">oferta</a></li>
                <li class="site-nav__item site-nav__item--vertical"><a href="#portfolio" class="site-nav__link">portfolio</a></li>
                <li class="site-nav__item site-nav__item--vertical"><a href="#kontakt" class="site-nav__link">kontakt</a></li>
            </ul>
        </nav>
    </div>
    ...
    <section data-aos="fade-up" id="oferta" class="site-section section-03">
        ...
        <div class="flex-wrapper">
            <div data-aos="fade-right" class="flex-wrapper__offer-item">
                ...
                <h3 class="offer-item__title">pakiet terra <span class="distinction-color distinction-color--word-break">mini</span></h3>
            ...
            <div data-aos="fade-up" class="flex-wrapper__offer-item offer-item--main">
                ...
                <h3 class="offer-item__title">pakiet terra <span class="distinction-color distinction-color--word-break">standard</span></h3>
            ...
            <div data-aos="fade-left" class="flex-wrapper__offer-item">
                ...
                <h3 class="offer-item__title">pakiet terra <span class="distinction-color distinction-color--word-break">premium</span></h3>
            ...
            <aside data-aos="fade-left" class="site-section__aside aside-06">
                ...
                <div class="swiper-container">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div id="1" class="swiper-slide" style="background-image:url(https://www.nasa.gov/sites/default/files/styles/full_width_feature/public/thumbnails/image/churning.jpeg)">
                        ...
                        <div id="2" class="swiper-slide" style="background-image:url(https://i.pinimg.com/originals/ec/b9/f1/ecb9f1b33ebeacc1088392bf065f58e2.jpg)">
                            <div class="project-desc title">
                                <h3 class="subtitle" data-swiper-parallax="-200">Subtitle</h3>
                                <div class="text" data-swiper-parallax="-100">
                                    <p>Długie zdjęcie test, Lorem ipsum dolor sit amet, consectetur adipiscing elit. Opis projektu tutaj</p>
                                </div>
                            </div>
                        </div>
                     
                        <div id="3" class="swiper-slide" style="background-image:url(https://www.nasa.gov/sites/default/files/styles/full_width_feature/public/thumbnails/image/iss056e162821.jpg)">
                            <div class="project-desc title">
                                <h3 class="subtitle" data-swiper-parallax="-200">Subtitle</h3>
                                <div class="text" data-swiper-parallax="-100">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Opis projektu tutaj</p>
